 ...
 * {@link com.bmstu.drivers.manager.core.service.impl.DriverLocalServiceImpl} and is the
 ...
 * @see com.bmstu.drivers.manager.core.service.base.DriverLocalServiceBaseImpl
 * @see com.bmstu.drivers.manager.core.service.impl.DriverLocalServiceImpl
 * @generated
 */
@ProviderType
public class DriverLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.bmstu.drivers.manager.core.service.impl.DriverLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<com.bmstu.drivers.manager.core.model.Driver> getDrivers(
		int start, int end) {
	...
	*/
	public static com.bmstu.drivers.manager.core.model.Driver addDriver(
		com.bmstu.drivers.manager.core.model.Driver driver) {
		return getService().addDriver(driver);
	}

	public static com.bmstu.drivers.manager.core.model.Driver addDevice(long driverId,
			java.lang.String driverName, java.lang.String description, 
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
			throws com.liferay.portal.kernel.exception.PortalException {
			return getService()
					   .addDriver(driverId, driverName, description, serviceContext);
		}
	...
	*/
	public static com.bmstu.drivers.manager.core.model.Driver createDriver(long driverId) {
	...
	*/
	public static com.bmstu.drivers.manager.core.model.Driver deleteDriver(long driverId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @return the driver that was removed
	*/
	public static com.bmstu.drivers.manager.core.model.Driver deleteDriver(
		com.bmstu.drivers.manager.core.model.Driver driver) {
		return getService().deleteDriver(driver);
	}

	public static com.bmstu.drivers.manager.core.model.Driver fetchDriver(long driverId) {
	...
	* @throws PortalException if a driver with the primary key could not be found
	*/
	public static com.bmstu.drivers.manager.core.model.Driver getDriver(long driverId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.bmstu.drivers.manager.core.model.Driver updateDriver(
		com.bmstu.drivers.manager.core.model.Driver driver) {
	...
	private static ServiceTracker<DriverLocalService, DriverLocalService> _serviceTracker =
		ServiceTrackerFactory.open(DriverLocalService.class);
}